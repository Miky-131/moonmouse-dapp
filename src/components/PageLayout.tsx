      ...
      >
        ...
        {/*{isMobile ? (
          ...
          <>
            ...
            <SideMenu className="flex-container bg-navbar grid-area-b mobile:hidden" />
          </>
        )}*/}
        <main
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* content */}
        <div className="grow text-sm leading-normal text-gray-400 scrollbar-width-thin overflow-auto h-96 mobile:h-12 rounded p-4 my-6 mobile:my-4 bg-field">
          <p className="mb-3">
  ...
  const mobileNavContent = (
    <Grid className="grid-cols-[1fr,2fr,1fr] gap-2 mobile:px-5 mobile:py-3 items-center bg-navbar cyberpunk-bg-light">
      ...
      {barTitle ? (
        ...
        <Link className="place-self-center" href="https://example.com">
            ...
            <Col className="pb-2 px-4 divide-y divide-gray-600">
              {titles.map(({ value, itemLabel = value }) => {
                return (
                  <div
                    key={value}
                    className={`py-4 px-6 font-normal ${value === currentValue ? 'text-color' : 'text-gray-400 '
                      }`}
                    onClick={() => {
                      onChange?.(value)
      ...
      >
        ...
        <Link href="/" className="m-2 mb-8">
          <div className="logo" style={{
            ...
            <img src="/img/moonmouse-big.png" alt="Moon Mouse" style={{ height: "30px", marginRight: "3px" }} />
            <span style={{ fontSize: "28px", color: "#9777b1", fontWeight: "bold" }}>Moon Mouse</span>
          </div>
        </Link>
        <Col className="grid grid-rows-[2fr,1fr,auto] mobile:grid-rows-[6fr,2fr,auto] smh:grid-rows-[6fr,2fr,auto] flex-1 overflow-hidden">
          <div className="shrink overflow-y-auto min-h-[120px] py-4 space-y-1 mobile:py-0 px-2 mobile: mb-2">
            <LinkItem icon="/icons/home.png" href="/" isCurrentRoutePath={pathname === '/'}>
              Home
            </LinkItem>
            <LinkItem icon="/icons/swap.png" href="/swap" isCurrentRoutePath={pathname === '/swap'}>
              Swap
            </LinkItem>
            <LinkItem icon="/icons/liquidity.png" href="/liquidity/add" isCurrentRoutePath={pathname === '/liquidity/add'}>
              Liquidity
            </LinkItem>
            {/*<LinkItem icon="/icons/farm.png" href="/farms" isCurrentRoutePath={pathname === '/farms'}>
              Farms
            </LinkItem>*/}
            <LinkItem icon="/icons/staking.png" href="/staking" isCurrentRoutePath={pathname === '/staking'}>
              Staking
            </LinkItem>
          </div>
            ...
            <div className="flex-1 overflow-auto no-native-scrollbar mt-2 mx-4">
              <div className="flex flex-row flex-wrap mobile:flex-nowrap smh:flex-nowrap justify-center" style={{ flexDirection: "column" }}>
                ...
                <div className="flex flex-col">
                  <a target="_blank" rel="noreferrer" className="text-center mt-1.5 ml-2 btn-small" href="https://example.com">
                    Audit
                  </a>
                </div>
*/}
          ...
          {/*<Col className="overflow-scroll no-native-scrollbar flex items-center justify-between mobile:ml-6 mobile:mb-1">
            <div className="flex flex-row overflow-auto no-native-scrollbar">
              <OptionItem noArrow href="https://coinmarketcap.com/currencies/" iconSrc="/icons/cmc.png"><></></OptionItem>
              <OptionItem noArrow href="https://dextools.io/app/en/solana/pair-explorer/" iconSrc="/icons/dextools.svg"><></></OptionItem>
              <OptionItem noArrow href="https://dexscreener.com/solana/" iconSrc="/icons/dexscreener.svg"><></></OptionItem>
              <OptionItem noArrow href="https://birdeye.so/token/" iconSrc="/icons/birdeye.png"><></></OptionItem>
            </div>
          </Col>*/}

          <Col className="overflow-scroll no-native-scrollbar flex items-center justify-between mobile:ml-6 mobile:mb-1">
            <div className="flex flex-row overflow-auto no-native-scrollbar">
              <OptionItem noArrow href="https://example.com/whitepaper.pdf" iconSrc="/icons/msic-docs.svg"><></></OptionItem>
              <OptionItem noArrow href="https://t.me/" iconSrc="/icons/media-telegram.svg"><></></OptionItem>
              <OptionItem noArrow href="https://x.com/" iconSrc="/icons/media-twitter.svg"><></></OptionItem>
              <OptionItem noArrow href="https://tiktok.com/" iconSrc="/icons/media-tiktok.svg"><></></OptionItem>
            </div>
          </Col>
...
function LinkItem({
  ...
  return (
    <div className="tgmenu__navbar-wrap" style={{ margin: "0", padding: "0", marginTop: "-32px" }}>
...
function CommunityPopover() {
  ...
  return (
    <>
      <div className="pt-3 -mb-1 mobile:mb-2 px-6 text-gray-400 text-xs mobile:text-sm">COMMUNITY</div>
        ...
        >
          <Row className="flex items-center justify-between">
            ...
            <Icon
              ...
              size="sm"
              className="justify-self-end m-2 text-gray-400"
            />
          </Row>
        </PageLayoutPopoverDrawer>
...
function RpcConnectionPanelPopover({ close: closePanel }: { close: () => void }) {
  ...
  return (
    <>
      <div className="pt-3 -mb-1 mobile:mb-2 px-6 mobile:px-3 text-gray-400 text-xs mobile:text-sm">
        RPC CONNECTION
      </div>
