  ...
  return (
    ...
    >
      {isMobile ? (
        ...
        <Button
          className="tg-border-btn px-2 py-2 bg-purple-500 text-white rounded-lg whitespace-nowrap menu-item"
          onClick={() => {
            if (!publicKey) useAppSettings.setState({ isWalletSelectorShown: true })
          }}
        >
          {connected ? (
            <Row className="items-center gap-3 my-0.5" >
              ...
              <div className="text-sm font-medium text-white menu-item">
