...
import { MMOUSEMint, SOLMint } from './wellknownToken.config'
...
export const RAYDIUM_MAINNET_TOKEN_LIST_NAME_DEPRMMOUSEED = 'Raydium Mainnet Token List'
...
export const useToken = create<TokenStore>((set, get) => ({
  ...
  getToken(
    ...
    if (token && toPubString(mint) === "99999999999999999999999999999999999999999999") {
      token.symbol = "MMOUSE"
