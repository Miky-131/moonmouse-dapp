...
export default function PoolsPage() {
  ...
  return (
    <PageLayout contentButtonPaddingShorter mobileBarTitle="Pools" metaTitle="Pools - Moon Mouse">
      <PoolHeader />
      <PoolCard />
    </PageLayout>
  )
      ...
      >
        <Row>
          <div className="flex-grow">
            <div className="text-gray-400 font-medium text-sm mobile:text-2xs mb-1">Your Liquidity</div>
        ...
        <Row>
          <div className="flex-grow">
            <div className="text-gray-400 font-medium text-sm mobile:text-2xs mb-1">Assets Pooled</div>
            <div className="text-color font-medium text-base mobile:text-xs">
        ...
        <Row>
          <div className="flex-grow">
            <div className="text-gray-400 font-medium text-sm mobile:text-2xs mb-1">Your Share</div>
            <div className="text-color font-medium text-base mobile:text-xs">
...
function TextInfoItem({ name, value }: { name: string; value?: any }) {
  ...
  return isMobile ? (
    <div>
      <div className="mb-1 text-gray-400 font-medium text-2xs">{name}</div>
