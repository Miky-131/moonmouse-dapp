...
export default function Liquidity() {
  return (
    <LiquidityUIContextProvider>
      <LiquidityEffect />
      <PageLayout mobileBarTitle="Liquidity" metaTitle="Liquidity - Moon Mouse">
        <LogoAndBackground />
        <div className="text-center justify-center mb-2">
          <img src="/img/Liquidity.png" className='mx-auto' style={{ maxHeight: "60px" }} />
        </div>
        <div className="ResponsiveFlexLayout">
          {/* <div className="LeftColumn">
            <div className="flex text-center justify-center">
              <h1 className="text-6xl">Moon Mouse Liquidity</h1>
            </div>
            <br />
  ...
  return (
    <div className={twMerge('bg-tooltip rounded-xl py-3 px-6 mobile:px-4', className)}>
      ...
      <Checkbox
        ...
        label={<div className="text-sm italic text-gray-400">Confirm</div>}
      />
      ...
      <Checkbox
        ...
        label={<div className="text-sm italic text-gray-400">Do not warn again for this pool</div>}
      />
    </div>
  )
}
    ...
    >
      <Col className="w-full">
        ...
        <Collapse openDirection="upwards" className="w-full">
          ...
          <Collapse.Face>
            {({ isOpen }) => (
              <Row className="w-full items-center text-xs font-medium text-gray-400 cursor-pointer select-none">
  ...
  return (
    <div className="mt-12 max-w-[456px] self-center">
      ...
      <Card className="p-6 mt-6 mobile:py-5 mobile:px-3 bg-light-card-bg" size="lg">
        ...
        <div className="text-xs mobile:text-2xs font-medium text-gray-400">
