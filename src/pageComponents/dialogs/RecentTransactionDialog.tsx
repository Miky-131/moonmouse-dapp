...
function PanelContent({ historyItems, onClose }: { historyItems: TxHistoryInfo[]; onClose(): void }) {
  ...
  return (
    ...
    >
      ...
      >
        {/* table head column: Transaction type */}
        <div className="font-medium text-gray-400 text-xs">Transaction type</div>
        {/* table head column: Details */}
        <div className="font-medium text-gray-400 text-xs">Details</div>
        {/* table head column: Date and time */}
        <div className="font-medium text-gray-400 text-xs">Date and time</div>
      </Row>
