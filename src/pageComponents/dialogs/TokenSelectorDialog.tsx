...
import { MMOUSEMint, USDCMint, USDTMint } from '@/application/token/wellknownToken.config'
        ...
        <>
          <div className="px-8 mobile:px-6 pt-6 pb-5">
            ...
            <Row className="justify-between">
              {([MMOUSEMint, QuantumSOLVersionSOL, USDTMint, USDCMint] as const).map((mintish, idx) => {
