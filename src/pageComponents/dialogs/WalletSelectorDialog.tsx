  ...
  return (
    ...
    >
      ...
      <Row className="grow items-center justify-between flex-wrap">
        <div className="mobile:text-sm text-base font-bold">{wallet.adapter.name}</div>
        {detected && !isMobile && (
          <Badge
  ...
  return (
    ...
    >
      <Row className="items-center justify-between p-8 mobile:p-4">
        <div className="text-xl mobile:text-lg font-semibold text-color">Connect your wallet to Moon Mouse</div>
        <Icon className="text-color cursor-pointer" heroIconName="x" onClick={close} />
      </Row>

      {/* Disclaimer */}
      {/*<div className="grow text-sm mobile:text-xs leading-normal text-gray-400 rounded p-4 mobile:p-2 mobile:px-4 mb-6 mobile:mb-4 mx-8 mobile:mx-6 bg-field">
