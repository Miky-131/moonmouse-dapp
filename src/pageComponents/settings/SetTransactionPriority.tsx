  ...
  return (
    <>
      <Row className="items-center mb-3 mobile:mb-6 gap-2">
        <div className="text-gray-400 text-xs mobile:text-sm">TRANSACTION PRIORITY</div>
        <Tooltip placement="bottom-right">
          <Icon size="sm" heroIconName="question-mark-circle" className="cursor-help text-gray-400" />
